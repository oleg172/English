...
public final class MainMenuCallback {

    public static final String TRANSLATE = "main_menu:translate";//поиск перевода
    ...
    public static final String LEARNING = "main_menu:learning";
